...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "This projectile model involves calculating the \"low ball\" and \"high ball\"\ntrajectories, going towards the fixed target position (X,Y).\n\n"
                                      "Information is provided about the minimum required launch speed to reach the\ntarget, the angle that the projectile should be launched at from this minimum\nspeed, and the flight time with this speed.\n\n"
                                      "There is also information about the angles for the low ball and high ball\ntrajectories, and their times of flight."))