...
# Form implementation generated from reading ui file 'challenge5_info.ui'
#
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "This trajectory model combines all the techniques from the previous challenges, displaying the \"low ball\", \"high ball\", and minimum launch speed trajectories to a fixed target (X,Y), as well as the trajectory maximising range given the same launch height and launch speed.\n"
"\n"
"This model also displays the bounding parabola, displaying the set of possible trajectories given the input launch speed. This is calculated by taking the equation for y position. (As this is a quadratic, the possible values are when there are one or two real solutions: in other words, the discriminant must be greater than or equal to 0.)\n"
"\n"
