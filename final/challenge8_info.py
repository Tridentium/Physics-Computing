...
# Form implementation generated from reading ui file 'challenge8_info.ui'
#
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.challengeTitleLabel.setText(_translate("MainWindow", "Challenge 8: Trajectory with Bounces Info"))
        self.backButton.setText(_translate("MainWindow", "Back"))
        self.label.setText(_translate("MainWindow", "This considers the situation in which a projectile, assuming constant acceleration, can bounce. The extent to which the ball bounces is determined by the coefficient of restitution (0 to 1), measuring how elastic the collision is (how much kinetic energy is conserved in the collision). To calculate the projectile trajectory in this challenge, the Verlet method is used.\n"
"\n"
