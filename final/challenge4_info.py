...
# Form implementation generated from reading ui file 'challenge4_info.ui'
#
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "This model displays two trajectories: one regular trajectory (displaying what would happen if the projectile was launched with the input launch angle) and another trajectory maximising horizontal range with the same launch height and launch speed. This is done by changing the launch angle, calculated by taking the range equation and taking its derivative to solve for theta.\n"
"\n"
