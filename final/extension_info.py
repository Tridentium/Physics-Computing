...
# Form implementation generated from reading ui file 'challenge10_info.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(180, 15, 671, 114))
...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(40, 140, 961, 591))
        font = QtGui.QFont()
        font.setFamily("Meiryo UI")
        ...
        self.codeButton = QtWidgets.QPushButton(self.frame)
        self.codeButton.setGeometry(QtCore.QRect(870, 20, 131, 101))
        font = QtGui.QFont()
        font.setFamily("Meiryo UI")
        font.setPointSize(24)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.challengeTitleLabel.setText(_translate("MainWindow", "Extension: Satellite Orbitting a Spherical Planet Info"))
        self.backButton.setText(_translate("MainWindow", "Back"))
        self.label.setText(_translate("MainWindow", "This 3D model considers the path of a satellite orbitting a spherical planet, ending in two scenarios: exceeding the set simulation time or the satellite colliding with the planet. (Code for calculating this path is accessible in the top-right.)\n"
"\n"
...
"\n"
"The satellite\'s path begins with the lighter blue colour, and ends with the darker purple colour. Output information is rounded to 5 decimal places where necessary. Also note that this graph is interactive - try dragging the graph!"))
